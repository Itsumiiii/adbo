    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <!-- Note: sidebarOpen is defined in app.blade.php -->
            ...
            <!-- Settings Dropdown (Desktop & Mobile unified for simplicity in this topbar style) -->
            <div class="flex items-center sm:ms-6">
                <!-- User Name for Desktop -->
                 <div class="hidden sm:block mr-2 text-sm text-gray-500 text-right">
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="flex items-center text-sm font-medium text-gray-500 hover:text-gray-700 focus:outline-none transition duration-150 ease-in-out">
                             <div class="h-9 w-9 rounded-full bg-indigo-100 flex items-center justify-center text-indigo-600 font-bold border-2 border-white shadow-sm">
